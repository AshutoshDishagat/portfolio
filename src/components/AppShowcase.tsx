...
export default function AppShowcase() {
  return (
    <section className="relative w-full py-24 sm:py-32 flex justify-center overflow-hidden bg-black text-white px-6">
      ...
      <div className="max-w-4xl w-full flex flex-col items-center text-center relative z-10 space-y-8">
        ...
        <motion.div
          ...
          className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full border border-white/20 bg-white/5 backdrop-blur-md"
        >
        ...
        >
          <Link
            ...
            className="group flex items-center justify-center space-x-3 bg-white text-black px-8 py-4 sm:px-10 sm:py-5 rounded-full font-bold text-lg hover:bg-gray-200 hover:scale-105 active:scale-95 transition-all duration-300 w-full sm:w-auto shadow-[0_0_40px_rgba(255,255,255,0.2)]"
          >
